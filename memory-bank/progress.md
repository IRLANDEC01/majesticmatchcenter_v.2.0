...
- **Админ-панель (UI)**:
  - Создание базового интерфейса для управления игроками и семьями.
  - Реализация форм для создания и редактирования сущностей с использованием централизованных Zod-схем для валидации на фронтенде.
- **Тестирование UI**: Написание базовых тестов для компонентов админ-панели.
- **Полный цикл турнира**: Реализация UI для создания, запуска и завершения турнира с распределением наград.
